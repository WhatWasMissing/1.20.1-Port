...
for token in ["PdaVoicePacket.class", "WelcomeBriefingPacket.class", 'PROTOCOL = "15"']:
...
require(welcome_packet, "ClientWelcomeOpener::openFirstWorldBriefing", "welcome packet")
...
for token in ["voiceLineFor", "reconstruction_complete", "closed_loop", "orpheus_security", "icarus_warning"]:
...
require(researcher, "ModNetwork.openDialogue", "researcher dialogue")
require(defector, "ModNetwork.openDialogue", "defector dialogue")
