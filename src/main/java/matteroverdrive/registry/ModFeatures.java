...
public final class ModFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> CRASHED_SHIP = FEATURES.register("crashed_ship", () -> new ModernizedStructureFeature(NoneFeatureConfiguration.CODEC, LegacyParityStructureFeature.Kind.CRASHED_SHIP));
