...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<DefectorAndroidEntity>> DEFECTOR_ANDROID = ENTITY_TYPES.register("defector_android", () -> EntityType.Builder.of(DefectorAndroidEntity::new, MobCategory.CREATURE).sized(0.6F,1.8F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":defector_android"));
    public static final RegistryObject<EntityType<OrpheusSecurityEntity>> ORPHEUS_SECURITY = ENTITY_TYPES.register("orpheus_security", () -> EntityType.Builder.of(OrpheusSecurityEntity::new, MobCategory.MONSTER).sized(0.6F,1.8F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":orpheus_security"));
    public static final RegistryObject<EntityType<ResonantAndroidEntity>> RESONANT_ANDROID = ENTITY_TYPES.register("resonant_android", () -> EntityType.Builder.of(ResonantAndroidEntity::new, MobCategory.MONSTER).sized(0.6F,1.8F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":resonant_android"));
    public static final RegistryObject<EntityType<FacilityResearcherEntity>> FACILITY_RESEARCHER = ENTITY_TYPES.register("facility_researcher", () -> EntityType.Builder.of(FacilityResearcherEntity::new, MobCategory.CREATURE).sized(0.6F,1.95F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":facility_researcher"));
