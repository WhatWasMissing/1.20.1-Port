...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<DroneEntity>> DRONE = ENTITY_TYPES.register("drone", () -> EntityType.Builder.of(DroneEntity::new, MobCategory.MONSTER).sized(0.8F,0.8F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":drone"));
    public static final RegistryObject<EntityType<MutantScientistEntity>> MUTANT_SCIENTIST = ENTITY_TYPES.register("mutant_scientist", () -> EntityType.Builder.of(MutantScientistEntity::new, MobCategory.MONSTER).sized(1.5F,2.9F).clientTrackingRange(10).build(MatterOverdrive.MOD_ID+":mutant_scientist"));
