...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<SpacetimeAcceleratorBlockEntity>> SPACETIME_ACCELERATOR = BLOCK_ENTITIES.register("spacetime_accelerator", () -> BlockEntityType.Builder.of(SpacetimeAcceleratorBlockEntity::new, ModBlocks.get("spacetime_accelerator").get()).build(null));
