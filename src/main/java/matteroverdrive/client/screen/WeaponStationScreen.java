...
public class WeaponStationScreen extends AbstractContainerScreen<WeaponStationMenu> {
    ...
    @Override protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) { graphics.drawString(font, title, 8, 6, 0xffffff); graphics.drawString(font, "Gun modules", 44, 20, 0xffaaaaaa); graphics.drawString(font, inventoryLabel, 8, imageHeight-94, 0xffffff); }
}
