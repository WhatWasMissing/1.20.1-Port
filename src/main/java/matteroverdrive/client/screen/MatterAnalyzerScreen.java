...
public class MatterAnalyzerScreen extends AbstractContainerScreen<MatterAnalyzerMenu>{
 public MatterAnalyzerScreen(MatterAnalyzerMenu m,Inventory i,Component t){super(m,i,t);imageWidth=176;imageHeight=166;inventoryLabelY=73;}
