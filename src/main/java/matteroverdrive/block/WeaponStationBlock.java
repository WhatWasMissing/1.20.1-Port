...
public class WeaponStationBlock extends BaseEntityBlock {
    ...
    public WeaponStationBlock(Properties properties) { super(properties.noOcclusion()); }
    ...
    @Override public void onRemove(BlockState oldState, Level level, BlockPos pos, BlockState newState, boolean moving) {
        if (!oldState.is(newState.getBlock()) && level.getBlockEntity(pos) instanceof WeaponStationBlockEntity station) station.dropContents();
