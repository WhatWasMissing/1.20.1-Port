...
public final class MatterOverdrive {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        LOGGER.info("M1 VERIFY: Matter Overdrive registry shell initialized - blocks={}, blockItems={}, standaloneItems={}, sounds={}, nativeDestinyWeapons={}, nativeDestinySounds={}", ModBlocks.all().size(), ModItems.BLOCK_ITEMS.size(), ModItems.STANDALONE_ITEMS.size(), ModSounds.all().size(), ModDestinyItems.WEAPONS.size(), ModDestinySounds.size());
