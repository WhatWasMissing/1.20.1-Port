...
- Android HUD energy/state synchronisation. Persistent Android XP/level progression foundation (levels 1-10, XP from conversion, part installation and successful active abilities) with server-synchronised HUD display.
