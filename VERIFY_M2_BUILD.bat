...
echo.
echo [1/9] Facility layout reachability gate...
...
echo.
echo [2/9] Native structure expansion gate...
...
echo.
echo [3/9] Whole-port consistency audit...
...
echo.
echo [4/9] Android power/progression consistency gate...
...
echo.
echo [5/9] Energy-weapon consistency gate...
...
echo.
echo [7/9] Re-running the verified M1 resource gate...
...
echo.
echo [8/9] Checking the M2 functional-machines source gate...
...
echo.
echo [9/9] Clean Forge compilation...
