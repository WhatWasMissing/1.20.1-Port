...
- `ANDROID_POWER_STATE_HARDENING.md` — chassis-adjusted Android capacity, client sync and progression-display consistency.

## Testing

Manual test plans and verification notes live in [`testing/`](testing/).

For the current `testing/tech-overhaul` build, start with [`testing/TO_TEST.md`](testing/TO_TEST.md).
